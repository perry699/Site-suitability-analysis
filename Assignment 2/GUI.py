...
def calculate():
    ...
    # 添加colorbar的位置，[left, bottom, width, height]
    cbar_ax = fig_s.add_axes([0.63, 0.12, 0.02, 0.77])
    fig_s.colorbar(img2, cax=cbar_ax)
    # Add a title to the plot
    ax2.set_title('Suitability Map')
    # Adjust spacing between subplots
    plt.tight_layout() #Automatic spacing between subplots using the  fig_s.tight_layout()
